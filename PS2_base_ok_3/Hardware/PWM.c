...
void PWM_Init(void)
{
    ...
    // TIM4_CH1~CH4: PA8, PA9, PA10, PA11
...
// {
//     TIM_SetCompare1(TIM1, CompareValue); // 设置比较输出3的值
//     TIM_SetCompare3(TIM1, CompareValue); // 设置比较输出3的值
//     TIM_SetCompare1(TIM3, CompareValue); // 设置比较输出3的值
...
// {
//     TIM_SetCompare2(TIM1, CompareValue); // 设置比较输出4的值
//     TIM_SetCompare4(TIM1, CompareValue); // 设置比较输出4的值
//     TIM_SetCompare2(TIM3, CompareValue); // 设置比较输出4的值
...
void PWM_SetCompare(TIM_TypeDef *TIMx, uint8_t channel, uint16_t CompareValue)
{
    switch (channel) {
        case 1:
            TIM_SetCompare1(TIMx, CompareValue);
            break;
        case 2:
            TIM_SetCompare2(TIMx, CompareValue);
            break;
        case 3:
            TIM_SetCompare3(TIMx, CompareValue);
            break;
        case 4:
            TIM_SetCompare4(TIMx, CompareValue);
            break;
        default:
            break;
    }
