...
int main(void)
{
    ...
    while (1) {
        ...
        Motor_SetSpeed(1, map_0_255_to_minus100_100(PS2_LY)); // 电机控制
        Motor_SetSpeed(2, map_0_255_to_minus100_100(PS2_LY)); // 电机控制
        Motor_SetSpeed(3, map_0_255_to_minus100_100(PS2_LY)); // 电机控制
        Motor_SetSpeed(4, map_0_255_to_minus100_100(PS2_LY)); // 电机控制
