...
void Motor_SetSpeed(uint8_t MotorID, int16_t Speed)
{
    ...
    switch(MotorID)
    {
        case 1: TIMx = TIM4; ch_forward = 1; ch_backward = 2; break;
        case 2: TIMx = TIM4; ch_forward = 3; ch_backward = 4; break;
        case 3: TIMx = TIM3; ch_forward = 1; ch_backward = 2; break;
        case 4: TIMx = TIM3; ch_forward = 3; ch_backward = 4; break;
        default: return; // 错误 ID
    }
