...
void PWM_Init(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2 | GPIO_Pin_3; // 设置GPIO_Pin_2和GPIO_Pin_3为输出模式
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP; // 设置GPIO_Pin_2和GPIO_Pin_3为推挽输出模式
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz; // 设置GPIO_Pin_2和GPIO_Pin_3的速度为50MHz
    GPIO_Init(GPIOA, &GPIO_InitStructure); // 初始化GPIO_Pin_2和GPIO_Pin_3
    ...
    */
    ...
    TIM_OC4Init(TIM2, &TIM_OCInitStructure); // TIM2_CH3输出比较初始化
